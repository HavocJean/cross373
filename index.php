...
<div class="fraseefeito bg-dark">
  ...
  <hr>
    ...
    <!-- Sobre nós -->
<div id="sobre" class="sobrenos container-fluid">
  ...
  <div class="col-xs-12 col-sm-6">
    <div class="menu-section">
      ...
      <br>
        ...
        <button type="button" class= "btn btn-outline-dark" name="button">Agendar Experimental</button>
...
<div class="galeria container-fluid">
  ...
  <div class="card-body">
    ...
    <div class="col-lg-4">
      ...
      <div class="card" style="width:400px">
  <img class="card-img-top rounded" src="img/galeria2.jpg" alt="Card image">
  <div class="card-body">
    <h4 class="card-title">Crosstraining na Cross 373</h4>
    <p class="card-text">Prática com Kettlebell.</p>
